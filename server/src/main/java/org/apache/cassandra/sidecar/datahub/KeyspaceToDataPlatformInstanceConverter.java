...
{
    public KeyspaceToDataPlatformInstanceConverter(@NotNull final IdentifiersProvider identifiers)
    {
        super(identifiers);
    }
    ...
    @Override
    @NotNull
    public MetadataChangeProposalWrapper<DataPlatformInstance> convert(@NotNull final KeyspaceMetadata keyspace) throws URISyntaxException
    {
