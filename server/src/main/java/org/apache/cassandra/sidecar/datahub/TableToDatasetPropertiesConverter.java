...
/**
 * Converter class for preparing the Dataset Properties aspect
 */
public class TableToDatasetPropertiesConverter extends TableToAspectConverter<DatasetProperties>
{
    public TableToDatasetPropertiesConverter(@NotNull final IdentifiersProvider identifiers)
    {
        super(identifiers);
    }
    ...
    @Override
    @NotNull
    public MetadataChangeProposalWrapper<DatasetProperties> convert(@NotNull final TableMetadata table)
    {
    ...
    protected static TimeStamp convertTime(@NotNull final Instant javaTime)
    {
