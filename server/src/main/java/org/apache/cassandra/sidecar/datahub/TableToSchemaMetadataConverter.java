...
/**
 * Converter class for preparing the Schema Metadata aspect
 */
public class TableToSchemaMetadataConverter extends TableToAspectConverter<SchemaMetadata>
{
    ...
    public TableToSchemaMetadataConverter(@NotNull final IdentifiersProvider identifiers)
    {
        super(identifiers);
    }
    ...
    @Override
    @NotNull
    public MetadataChangeProposalWrapper<SchemaMetadata> convert(@NotNull final TableMetadata table)
    {
        ...
        final SchemaMetadata aspect = new SchemaMetadata()
     ...
     */
    @NotNull
    protected Stream<SchemaField> convertColumn(@NotNull final ColumnMetadata column)
    {
     ...
     */
    @NotNull
    protected Stream<SchemaField> convertType(@NotNull final String name,
     ...
     */
    @NotNull
    protected SchemaFieldDataType convertType(@NotNull final DataType.Name cassandraType)
    {
