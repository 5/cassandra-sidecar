...
/**
 * Converter class for preparing the Data Platform Instance Properties aspect
 */
public class ClusterToDataPlatformInstancePropertiesConverter extends ClusterToAspectConverter<DataPlatformInstanceProperties>
{
    ...
    public ClusterToDataPlatformInstancePropertiesConverter(@NotNull final IdentifiersProvider identifiers)
    {
        super(identifiers);
    }
    ...
    @Override
    @NotNull
    public MetadataChangeProposalWrapper<DataPlatformInstanceProperties> convert(@NotNull final Metadata cluster)
    {
        final String urn = identifiers.urnDataPlatform();

        final DataPlatformInstanceProperties aspect = new DataPlatformInstanceProperties()
