...
import org.apache.cassandra.sidecar.utils.SchemaUtils;
import org.apache.cassandra.testing.CassandraIntegrationTest;

import static org.assertj.core.api.Assertions.assertThat;

class SchemaUtilsIntegrationTest extends IntegrationTestBase
{
    ...
    void testSchemaUtils() throws IOException {
        ...
        createTestKeyspace();
        createTestTable("CREATE TABLE %s (identifier int PRIMARY KEY, "
                                       + "name ascii, "
        ...
        {
            actualJson = SchemaUtils.extractSchema(session.getCluster());
        }
